...
const GLfloat *ambient = PolishedBronzeAmbient;
const GLfloat *diffuse = PolishedBronzeDiffuse;
const GLfloat *specular = PolishedBronzeSpecular;
GLfloat shininess = PolishedBronzeShininess;
